      ...
      <section className="relative overflow-hidden py-20 sm:py-24 lg:py-32">
        ...
        <div className="container relative mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              Nasze <span className="text-pink-500">Kotki</span>
            </motion.h1>
            ...
            >
              Poznaj nasze wspaniałe kotki hodowlane, które wyróżniają się nie tylko pięknym wyglądem, ale także
          ...
          <div className="grid lg:grid-cols-3 gap-16 sm:gap-20">
            {cats.map((cat, index) => (
              <CatCard
                ...
                {...cat}
                index={index}
                isFemale={true} // Dodajemy prop dla rozróżnienia płci
              />
            ))}
          </div>
        </div>
