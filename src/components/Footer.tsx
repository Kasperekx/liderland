      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="py-16 sm:py-24">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-300 max-w-md">{footer.about}</p>
            </div>
            ...
            <motion.div
              ...
              className="space-y-4"
            >
              <h3 className="text-lg font-semibold text-white">{footer.contact.title}</h3>
            ...
            <motion.div
              ...
              className="space-y-4"
            >
              <h3 className="text-lg font-semibold text-white">{footer.social.title}</h3>
        ...
        <div className="border-t border-white/10 py-6">
          <p className="text-center text-gray-400 text-sm">
            © {new Date().getFullYear()} Liderland*PL. {footer.copyright}
          </p>
        </div>
      </div>
