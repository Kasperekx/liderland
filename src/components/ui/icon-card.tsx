...
export function IconCard({ icon, title, description, className, ...props }: IconCardProps) {
  return (
    <div
      className={cn(
    ...
    >
      <div className="space-y-4">
        <div className="inline-flex p-3 rounded-2xl bg-pink-100 text-pink-600">{icon}</div>
